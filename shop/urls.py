...
from shop.views import ProductsListView, ProductsDetailView
...
urlpatterns = [
    ...
    path('detail/<int:pk>/',
         ...
         name='shop_detail'),
    path('add-item-to-cart/<int:pk>', views.add_item_to_cart,
         name='add_item_to_cart'),
    path('delete_item/<int:pk>', views.CartDeleteItem.as_view(),
